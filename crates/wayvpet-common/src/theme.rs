...
//! binario `wayvpet` (`src/theme.rs`), que necesita el sistema de ficheros.

use crate::config::split_line;

/// Versión del **formato** de tema que entiende este wayvpet. Un tema con
...
/// ¿Soporta este wayvpet el formato de este tema?
#[must_use]
